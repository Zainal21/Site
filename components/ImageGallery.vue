<template>
  <div class="flex flex-row flex-wrap -mx-2">
    <div class="w-full md:w-1/2 h-64 md:h-auto mb-4 px-2">
      <span class="block w-full h-full bg-grey-dark bg-no-repeat bg-center bg-cover cursor-pointer overflow-hidden  hover:shadow-lg hover:border-1 hover:border-gray-500 border-4 border-gray-800 rounded-lg"
